 ...
 *
 * The CANN 9.0.1 BlockSparseAttention headers used by this derivative are
 * vendored below op_kernel/vendor so the dynamic-source operator package is
 * self-contained.  Those files retain Huawei's CANN Open Software License
 * Agreement Version 2.0 notices; see op_kernel/vendor/README.md.
 *
 * Cache layout is fixed BSND:
 *   [physical_page, 128, 8, 128].
 */

#include "vendor/cann_9_0_1/block_sparse_attention/kernel_common.hpp"
